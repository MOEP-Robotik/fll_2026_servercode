...
class MailService {
    ...
    private function getEmailContent(string $vorname, string $nachname, string $coordinate, string $date, string $email, string $telephone, string $plz, string $timestamp): string {
        $base = <<<'HTML'
